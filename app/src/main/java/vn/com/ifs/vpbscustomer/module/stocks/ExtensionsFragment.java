...
public class ExtensionsFragment extends BaseViewStubFragment {
    ...
    public static ExtensionsFragment newInstance(String param1, String param2) {
    ...
    protected int getViewStubLayoutResource() {
        return R.layout.fragment_extensions;
    }
}
